...
public final class ConfigOptions {
    public static class Common {
        ...
        public Common(ForgeConfigSpec.Builder server) {
            ...
            //worldGenSpecialParameters = server.comment("VOID-NOT USED, OVERWORLD-NOT USED, SUPERFLAT-Use the string as used for normal flat worlds, WORLDTYPE-world type to be used (set like server level-types), CUSTOMIZED-NOT USED").define("worldGenSpecialParameters", "");
            ...
            server.comment("Config Settings for the world generation");
            server.comment("");
            //islandMainSpawnType = server.comment("This is for the island at 0,0! Valids are random, bedrock, sand, snow, wood, grass, gog, or others added by addons/custom islands").define("islandMainSpawnType", "bedrock");
            //islandSpawnType = server.comment("Valids are random, sand, snow, wood, grass, gog, or others added by addons/custom islands").define("islandSpawnType", "grass");
            ...
            //startingItems = server.comment("Starting items given to new players. Use the /startingInv command in game").define("startingItems", emptyFilledArray(36));
            ...
            //customIslands = server.comment("Custom islands using the structure block data. Files are to be placed in the " + SkyBlock.MODID + "structures config folder. The names in this list should be the same as the structure names. "+ "These names are the ids for the island type as well").define("customIslands", emptyFilledArray(0));
